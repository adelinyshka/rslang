...
const teamMembers = [
  ...
  },
  {
    ...
    description: `Занимался разработкой игры Speakit, реализовал отправку 
      статистики на сервер и переключатель уровней в играх. Помогал команде с реализацией логики.`,
    bgColor: '#DBF2EF',
    role: 'разработчик',
  },
  {
